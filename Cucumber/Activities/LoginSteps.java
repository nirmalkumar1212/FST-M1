...
//    }
    ...
    @Then("Read the page title and confirmation message as {string}")
    public void readTitleAndHeading(String confirmMessage ) {
        wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("action-confirmation")));
    ...
    @Then("^Read the page title and confirmation message$")
    public void readTitleAndHeading_Activity5() {
        wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("action-confirmation")));
